...
const convertTimestamp = (timestamp, timezoneOffset) => {
...
function getWeather(){
    const API_KEY = '579e062e769e36b95270ec73fa9fd25f';

fetch(`https://api.openweathermap.org/data/2.5/weather?q=${currCity}&appid=${API_KEY}&units=${units}`).then(res => res.json()).then
    (data => {
        console.log(data)
